...
class Model(GANModelDesc):
    ...
    def generator(self, z):
        ...
        x = self.toRGB(x, 'toRGB_256_256')
        return x

    @auto_reuse_variable_scope
    def discriminator(self, x):

        x = self.fromRGB(x, 'fromRGB_256_256')
...
def get_data():
    lmdb = "/graphics/projects/scratch/student_datasets/cgpraktikum17/vat/resized_256.lmdb"
...
if __name__ == '__main__':
    ...
    GANTrainer(
        ...
        steps_per_epoch=7500, # <- 30.000 / BATCH_SIZE
