...
class Model(GANModelDesc):
    ...
    def generator(self, z, alpha):
        ...
        x_left = self.toRGB(x, 'toRGBtemp_8_16')
    ...
    def discriminator(self, x, alpha):
        ...
        # Alpha without convolution
        x_left = Downsample('disDowntemp_8_16', x)
        x_left = self.fromRGB(x_left, 'fromRGBtemp_8_16')
        x_left_alpha = tf.multiply((1 - alpha), x_left)

        x = self.fromRGB(x, 'fromRGB_8_16')
    ...
    def _build_graph(self, inputs):
        ...
        real_img_prev = Upsample('real_img_prev_8_16', inputs[1])
