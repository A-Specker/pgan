...
class Model(GANModelDesc):
    ...
    def generator(self, z, alpha):
        ...
        x_left = self.toRGB(x, 'toRGBtemp_32_64')
        x_left_alpha = tf.multiply((1 - alpha), x_left)
        
        # Convolution layers for stage 16 16 256
    ...
    def discriminator(self, x, alpha):
        ...
        # Alpha without convolution
        x_left = Downsample('disDowntemp_32_64', x)
        x_left = self.fromRGB(x_left, 'fromRGBtemp_32_64')
        x_left_alpha = tf.multiply((1 - alpha), x_left)

        x = self.fromRGBTrans(x, 'fromRGB_32_64')
    ...
    def _build_graph(self, inputs):
        ...
        real_img_prev = Upsample('real_img_prev_32_64', inputs[1])
...
if __name__ == '__main__':
    ...
    GANTrainer(
        ...
        steps_per_epoch=3000, # <- 30.000 / BATCH_SIZE
