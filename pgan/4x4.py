...
class Model(GANModelDesc):
    ...
    def generator(self, z):
        ...
        x = self.toRGB(x, 'toRGB_4_4')
        return x

    @auto_reuse_variable_scope
    def discriminator(self, x):

        x = self.fromRGB(x, 'fromRGB_4_4')
...
def get_data():
    lmdb = "/graphics/projects/scratch/student_datasets/cgpraktikum17/vat/resized_4.lmdb"
...
if __name__ == '__main__':
    ...
    GANTrainer(
        ...
        session_init=SaverRestore(args.load, 'loaded') if args.load else None
    )
