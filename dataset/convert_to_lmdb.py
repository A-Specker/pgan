...
class resizeDataFlow(dataflow.DataFlow):
    ...
    def get_data(self):
        lmdb = "/graphics/scratch/datasets/celebHQ/celeb_hq.lmdb"
...
def resize_lmdb_content(size):
    resizedLMDBPath = "/graphics/projects/scratch/student_datasets/cgpraktikum17/vat/resized_" +  size + ".lmdb" 
...
def debug_lmdb(lmdb):
    ...
    # lmdb = "/graphics/scratch/datasets/celebHQ/celeb_hq.lmdb"
    lmdb = "/graphics/projects/scratch/student_datasets/cgpraktikum17/vat/resized.lmdb"
